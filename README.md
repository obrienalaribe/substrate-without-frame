...
- [Substrate Frameless Node Template](#substrate-frameless-node-template)
  - [Instructions](#instructions)
    - [Ungraded](#ungraded)
      - [Get Those Roots In Order!](#get-those-roots-in-order)
      - [Basic write](#basic-write)
      - [Make it Upgradable!](#make-it-upgradable)
      - [Opaque Transactions](#opaque-transactions)
      - [Opaque Decoding](#opaque-decoding)
      - [Timestamp](#timestamp)
      - [Optional: Get Block Author](#optional-get-block-author)
    - [Graded](#graded)
      ...
      - [(Optional) Tertiary Task: Consensus](#optional-tertiary-task-consensus)
...
`finalize_block`, and double-checked in `execute_block`.
...
Replay the upgrade scenario with a breaking extrinsic format. Will it work?
...
#### (Optional) Tertiary Task: Consensus
